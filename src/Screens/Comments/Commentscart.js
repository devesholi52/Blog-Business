...
export default function Commentscart({ navigation }) {
    return (
        <View style={styles.container}>
            <View style={styles.imageView}>
                ...
                <View style={styles.textcontainer}>
                    ...
                    <Text style={{ color: Color.gray, lineHeight: 20, fontFamily: Font.Regular,fontSize:13 }}>The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters</Text>
                </View>
            </View>
